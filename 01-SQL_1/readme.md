...
SQLite, sunucusuz (serverless), hafif ve gömülü (embedded) bir veritabanı sistemidir.
Mobil uygulamalarda (Android, iOS), masaüstü yazılımlarda ve küçük projelerde sıkça kullanılır.

Kurulum gerektirmez.

Tek bir .db dosyası üzerinde çalışır.

Küçük ve hızlıdır.

SQL standartlarını büyük ölçüde destekler.

🔹 2. SQL Komutları ile İlgili Sorular
❓ DDL ve DML farkı nedir?

DDL (Data Definition Language) → Yapı işlemleri
CREATE, DROP, ALTER

DML (Data Manipulation Language) → Veri işlemleri
SELECT, INSERT, UPDATE, DELETE

❓ PRIMARY KEY nedir?

Bir tabloda her satırı benzersiz yapan anahtardır.

❓ AUTOINCREMENT ne işe yarar?

Her yeni kayıt için otomatik artan ID üretir.

❓ WHERE yazmazsak ne olur?

Tüm kayıtlar etkilenir (güncelleme/silme riskli olur).

❓ JOIN nedir?

Birden fazla tabloyu ortak bir kolon üzerinden birleştirir.
